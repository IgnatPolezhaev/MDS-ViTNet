...
def main(args):
    ...
    if args.color:
        visualization(
            img_path, 
            path_to_save + "/map.png", 
            path_to_save + "/color_map.png", 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_th", default=230, type=int, help="amx treshold") 
    parser.add_argument("--min_th", default=110, type=int, help="min treshold") 
